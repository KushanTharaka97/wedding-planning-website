...
<html>
    <head>
        ...
        <title>Photo Shootings</title>
    </head>
    <body background="../img/services/photo.jpg">
        ...
        <%@page import="java.sql.*" %>
         ...
         <h1 align="center">Photo Shootings</h1>
         ...
         <%
                    ...
                    String sql="SELECT bname,email FROM sp WHERE btype='Photography ' " ;
